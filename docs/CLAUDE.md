...
│   │   ├── components/
│   │   │   ├── SwipeCard.tsx       # Food card with drag-to-swipe (tilt, NOPE/LIKE overlays, 120px threshold, spring snap-back); ✗/✓/Never buttons; cuisine image with emoji fallback; AllergenNote
