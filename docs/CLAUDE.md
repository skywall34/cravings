...
| P19 | Android via Capacitor: bundled wrap of the Vite app, async storage seam, native coarse geolocation, backend CORS, debug APK built in WSL (Linux SDK 35 + JDK 21). See ADR-0006 + `ANDROID_HANDOFF.md` | ✅ Code + scaffold + debug APK; device test + release/Play pending |
