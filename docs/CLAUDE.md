...
**P31 shipped. Remaining open work:**
...
- **Insights follow-ups** (deferred from P31 plan): stated-vs-revealed axis (onboarding `taste_prefs` vs revealed swipe averages); population-percentile normalization; μ-projection axes; nightly axis-score snapshot job.
